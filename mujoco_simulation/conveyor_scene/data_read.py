...
# print(os.getcwd())
df = pd.read_parquet('samples_000010000_to_000012113.parquet') # the train data of random scene

sample_indx = 5  # which sample in the dataset file is used (2114 in total)
#target_num = 3  # which robot/object is selected  (2 objects, 4 robots)
...
# save the traj of the 2 objects to two json files
...
# save the traj of the 4 robots to four json files
