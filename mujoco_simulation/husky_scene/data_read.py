...
# print(os.getcwd())
df = pd.read_parquet('samples_000030000_to_000032924.parquet') # the train data of random scene

sample_indx = 5  # which sample in the dataset file is used (2924 in total)
#target_num = 0  # which robot/object is selected  (2 objects, 2 robots)
