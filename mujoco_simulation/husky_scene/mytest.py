...
joint_states = []
for i in range(172):   # 474 joint states in total
...
obj_pos = []
obj_quat = []
for i in range(172):   # 474 object states in total
    obj_pos.append(obj[i]['pos']) # join_states:(474,7), obj[i]['pos'] - (0, 0, 0.6) as the table's height 
...
cam.azimuth = -85.80000000000028 ; cam.elevation = -35.39999999999999 ; cam.distance =  3.3883754731978364
cam.lookat =np.array([ -0.019463062849019604 , 0.0330630081893415 , 0.6614860239622438 ])
