...
# read the traj of the 4 objects
obj_pos = [[],[],[],[]]
obj_quat = [[],[],[],[]]
for obj_num in range(4):
    ...
    for i in range(obj_step.size):
        obj_pos[int(obj_name[3])-1].append([a - b for a, b in zip(obj_step[i]['pos'].tolist(), [0, 0.05, 0.55])])  #the first obj is obj1 instead of 0
...
while not glfw.window_should_close(window):
    ...
    data.qpos[12:15] = obj_pos[0][current_step][0:3]
    data.qpos[15:19] = obj_quat[0][current_step][0:4]
    data.qpos[19:22] = obj_pos[1][current_step][0:3]
    data.qpos[22:26] = obj_quat[1][current_step][0:4]
    data.qpos[26:29] = obj_pos[2][current_step][0:3]
    data.qpos[29:33] = obj_quat[2][current_step][0:4]
    data.qpos[33:36] = obj_pos[3][current_step][0:3]
    data.qpos[36:40] = obj_quat[3][current_step][0:4]
