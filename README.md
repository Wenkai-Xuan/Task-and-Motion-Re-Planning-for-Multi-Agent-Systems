...
```
cd existing_repo
git remote add origin https://gitlab.inf.ethz.ch/crl/tapas/msc_thesis/wenkai.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.inf.ethz.ch/crl/tapas/msc_thesis/wenkai/-/settings/integrations)
